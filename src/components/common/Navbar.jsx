      ...
      <header className="text-gray-600 body-font border-b-2">
        <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
          ...
          <nav className="md:ml-auto flex flex-wrap items-center text-base justify-center">
            ...
            <Link className="mr-5 hover:text-gray-900" to="/aichats">Chats With AI</Link>
            <Link className="mr-5 hover:text-gray-900" to="/contactus" >Contact Us</Link>
          </nav>
          
          <button onClick={()=>{navigate("/login")}}  className="inline-flex items-center w-16 bg-red-500 text-white border-0 py-1 px-3 focus:outline-none hover:bg-white hover:text-red-500 hover:border-2 hover:border-red-500 rounded text-base mt-4 md:mt-0">
           Login
          </button>
        </div>
      </header>
