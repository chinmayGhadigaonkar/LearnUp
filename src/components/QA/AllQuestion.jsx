  ...
  return (
    ...
    <div className='w-11/12 mx-auto  my-2 '>
        ...
        <header className='flex justify-between py-3 h-20  '>
          ...
          <button onClick={()=>{navigate("/askquestion")}} className=" text-white bg-black border-0 py-1 px-2 h-10 focus:outline-none hover:bg-white hover:border-red-500  hover:border-2 hover:text-red-500 rounded text-lg ">
          Ask Question
          </button>
